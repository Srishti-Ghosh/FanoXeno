...
do for [i=0:360] {
set view 66, 322, 1, 1.25
splot 'wparameter.txt' every::i+1::i+1 w l palette lw 6 notitle, 'wprmaux.txt' every::i+1::i+1 w l lw 4 lc 2 notitle, \
      'wparameter.txt' every::i+1::i+1 w i palette lw 0.5 notitle, \
