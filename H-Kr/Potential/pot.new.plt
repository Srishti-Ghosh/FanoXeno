...
set xlabel "Internuclear distance (a_{0})"
...
set key at 19.0,-4.0
plot 'l=0.pot.txt' w l lt 8 dt 1 lw 3 title "{/Times-Italic l} = 0" 
set key at 19.0,-3.2
plot 'l=1.pot.txt' w l lt 3 dt 3 lw 3 title "{/Times-Italic l} = 1"
set key at 19.0,-2.4
plot 'l=2.pot.txt' w l lt 4 dt 4 lw 3 title "{/Times-Italic l} = 2"
set key at 19.0,-1.6
plot 'l=3.pot.txt' w l lt 6 dt 5 lw 3 title "{/Times-Italic l} = 3"
set key at 19.0,-0.8
plot 'l=4.pot.txt' w l lt 7 dt 1 lw 3 title "{/Times-Italic l} = 4"
set key at 19.0, 2.5
plot 'l=5.pot.txt' w l lt 1 dt 7 lw 3 title "{/Times-Italic l} = 5"
set key at 19.0, 3.3
plot 'l=6.pot.txt' w l lt 8 dt 8 lw 3 title "{/Times-Italic l} = 6"
plot 0 w l lt 8 lw 2 notitle
plot 0.12398*4.13 w l lt 7 dt 5 lw 3 notitle
