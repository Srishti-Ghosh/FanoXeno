...
set ztics in 0,250,1000
#set view 63,38,1,1.25
do for [i=0:360]{
set view 63, i, 1, 1.25
splot 'angdcs.txt' w l palette lw 1.5 notitle, 'asydcs.raised.txt' w l palette lw 1.5 notitle
