...
!
! Modofied by F. K., 30 August 2022 and 1 September 2022
! to adjust the calculation of H + Kr collision system.
!
...
! Replaced by the H + Kr data
      ...
      DATA EPS/0.000216821d0/  ! well depth of Ne-Ne potential in Hartree
      data rs/9.1481048d0/ !Connecting point radius. = 4.8409685 Angstrom
!                                     Slightly modified from 4.83 Angstrom by Toennies.
...
! Replaced by the reduced mass of H + Kr.
