...
set output '/Users/srishtighosh/Downloads/CodesForColdCollisionProject/H+Xe/plots/l_7_plots/energy_angle_vs_asydcs_rotating.gif'
    ...
    set xrange [23.98:27.98]; set yrange [0:180]; set xyplane at 0.1
    set palette defined (0 "#000040", 1 "#0000ff", 2 "#00ffff", 3 "#00ff00", 4 "#ffff00", 5 "#ff0000")
    
    set title "H+Xe Synthesized Fano DCS (l=7)" font "Times New Roman, 20, bold"
    unset pm3d; set hidden3d front; set logscale cb; set cbrange [0.1:100]
    do for [ang=0:356:4] { set view 60, ang, 1, 1.2; splot '/Users/srishtighosh/Downloads/CodesForColdCollisionProject/H+Xe/plots/l_7_plots/asydcs.2pi.txt' every 3:3 w l palette lw 1.2 notitle }
